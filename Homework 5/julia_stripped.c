...
void julia_ppm(complex c, double* g, double rmin, double rmax, double imin, double imax, double maxnorm, double numsamples, double maxiter) {
  int i, j, flag;
...
void julia_monochrome(complex c, short int* g, double rmin, double rmax, double imin, double imax, double maxnorm, double numsamples, double maxiter) {
  int i, j, flag;
  for(i = 0; i < NUM_PIXELS; i++) {
    complex z = GET_Z;
    zn = z;
...
void julia_grayscale(complex c, double* g, double rmin, double rmax, double imin, double imax, double maxnorm, double numsamples, double maxiter) {
  int i, j, flag;
  for(i = 0; i < NUM_PIXELS; i++) {
    complex z = GET_Z;
    zn = z;
...
void julia_grayscale(complex c, double* r, double* g, double* b, double rmin, double rmax, double imin, double imax, double maxnorm, double numsamples, double maxiter) {
  int i, j, flag;
  for(i = 0; i < NUM_PIXELS; i++) {
    complex z = GET_Z;
    zn = z;
...
int main(int argc, char** argv){
  ...
  switch(outputformat) {
    case 0:
      julia_ppm(c, g, rmin, rmax, imin, imax, maxnorm, numsamples, maxiter);
      break;
    case 1:
      julia_monochrome(c, m, rmin, rmax, imin, imax, maxnorm, numsamples, maxiter);
      break;
    case 2:
      julia_grayscale(c, g, rmin, rmax, imin, imax, maxnorm, numsamples, maxiter);
      break;
    case 3:
      julia_rgb(c, r, g, b, rmin, rmax, imin, imax, maxnorm, numsamples, maxiter);
  }
