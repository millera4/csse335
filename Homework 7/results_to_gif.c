...
int create_gif(char* fname, int nr, int nc, double minx, double maxx, double miny, double maxy,vector* v, double r,int nv, int nt,int numframes){
...
void load_results(char* filename,vector** v,int* N, int* T,double* minxcoord,double* maxxcoord,double* minycoord,double* maxycoord){
...
int main ( int argc, char** argv ) {
  ...
  print_options(o);
  load_results(o.inputfile,&vs,&N,&T,&minx,&maxx,&miny,&maxy);
